    ...
    <main class="p-32">
        <div class="card w-full bg-base-100 shadow-xl">
            <div class="card-body space-y-5">
                ...
                <form action="/tambah/formulir/pemeriksaan" class="space-y-5" method="post">
                    @csrf   
                    <div class="form-control">
                    <label class="label">
                        <span class="label-text">NAMA CUSTOMER</span>
                    </label>
                    <input type="text" name="namaCustomer" placeholder="NAMA CUSTOMER ..." class="input input-bordered" />
                    </div>
                    <div class="form-control">
                    <label class="label">
                        <span class="label-text">ALAMAT CUSTOMER</span>
                    </label>
                    <input type="text" name="alamatCustomer" placeholder="ALAMAT CUSTOMER" class="input input-bordered" />
                    </div>
                    <div class="form-control">
                    <label class="label">
                        <span class="label-text">TANGGAL REGISTRASI</span>
                    </label>
                    <input type="text" value="{{ date('d F Y') }}" name="tanggalRegis" readonly class="input input-bordered" />
                    </div>
                    <div class="form-control">
                    <label class="label">
                        <span class="label-text">NAMA OPERATOR</span>
                    </label>
                    <input type="text" readonly value="{{ auth()->user()->namaOpertator }}" name="namaOperator" class="input input-bordered" />
                    </div>
                            ...
                            <table class="table w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="AirMinum">
                                            <input onchange="AirMinum()" type="number" id="jumlahAirminum" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifAirMinum" value="464000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" name="totalAirMinum" readonly id="totalAirMinum" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="AirBersih">
                                            <input onchange="AirBersih()" type="number" id="jumlahAirBersih" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifAirBersih" value="420000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalAirBersih" id="totalAirBersih" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="AirLimbahRs">
                                            <input onchange="AirLimbahRs()" type="number" id="jumlahAirLimbahRs" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifAirLimbahRs" value="257000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalAirLimbahRs" id="totalAirLimbahRs" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="AirSungai">
                                            <input onchange="AirSungai()" type="number" id="jumlahAirSungai" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifAirSungai" value="513000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalAirSungai" id="totalAirSungai" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="AirKolam">
                                            <input onchange="AirKolam()" type="number" id="jumlahAirKolam" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifAirKolam" value="52100" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalAirKolam" id="totalAirKolam" class="input input-bordered" />
                                        </td>
                                    </tr>
                                </tbody>
                            <!-- foot -->                          
                            ...
                            <table class="table w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="EColi">
                                            <input onchange="EColi()" type="number" id="jumlahEColi" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifEColi" value="63000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalEColi" id="totalEColi" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="Salmonela">
                                            <input onchange="Salmonela()" type="number" id="jumlahSalmonela" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifSalmonela" value="50000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalSalmonela" id="totalSalmonela" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="Jamur">
                                            <input onchange="Jamur()" type="number" id="jumlahJamur" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifJamur" value="60000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalJamur" id="totalJamur" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td id="KimiaFood">
                                            <input onchange="KimiaFood()" type="number" id="jumlahKimiaFood" class="input input-bordered" />
                                        </td>
                                        <td>
                                            <input type="number" readonly id="tarifKimiaFood" value="61000" class="input input-bordered" />
                                        </td>
                                        <td >
                                            <input type="number" readonly name="totalKimiaFood" id="totalKimiaFood" class="input input-bordered" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                        ...
                                        <td >
                                            <input onchange="totalBiaya()" type="number" name="TotalBiayaPemeriksaan" id="totalBiaya" class="input input-bordered" />
                                        </td>
                                    </tr>
                                </tbody>
                            <!-- foot -->                          
                    ...
                    <div class="form-control mt-6">
                        <button type="submite" class="btn btn-primary">Tambah Data</button>
                    </div>
                </form>
            </div>
          </div>
